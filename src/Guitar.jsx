...
export function Guitar(props) {
  ...
  const m_redPlastic = new THREE.MeshStandardMaterial({color: "#8c1521", roughness: 0.2})
  const m_greenPlastic = new THREE.MeshStandardMaterial({color: "#056647", roughness: 0.3})
  const m_yellowPlastic = new THREE.MeshStandardMaterial({color: "#c9a41e", roughness: 0.3})
  const m_bluePlastic = new THREE.MeshStandardMaterial({color: "#08149c", roughness: 0.3})
  const m_orangePlastic = new THREE.MeshStandardMaterial({color: '#e33a0b', roughness: 0.3})
